...
(function () {
  ...
  const SAMPLES = {
    ...
    'record-azure-aks': {
      vectorString: 'CRITv0.3.0/CP:MA/VS:FX/FP:VU/SR:CA/RL:SC/EV:T/PP:1706659200/SA:1528243200#CVE-2024-21626:aks:cluster',
      vuln_id: 'CVE-2024-21626',
      provider: 'azure', service: 'aks', resource_type: 'cluster',
      resource_lifecycle: 'stateful_customer',
      shared_responsibility: 'customer_action_required',
      vex_status: 'fixed',
      template: '/subscriptions/{subscription-id}/resourceGroups/{resource-group}/providers/Microsoft.ContainerService/managedClusters/{cluster-name}',
